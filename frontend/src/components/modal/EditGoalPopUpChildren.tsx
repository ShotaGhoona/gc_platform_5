...
import { GoalList } from './GoalListPopUpChildren';
import VisionSentence from '../VisionSentence';
...
export const EditGoalPopUpChildren = ({ onClose, addMonth }: EditGoalModalProps) => {
  const { user } = useUser();
