...
import { ExternalEvent, updateExternalEvent, ExternalEventTag, fetchExternalEventTags } from "../services/externalEventService";
...
export const EditExternalEventPopUpChildren = ({ onClose, event }: Props) => {
  ...
  const [selectedTagIds, setSelectedTagIds] = useState<number[]>(event.tags.map(t => t.id));
