  ...
  return (
    <div className="h-full w-full flex flex-col gap-2 items-center justify-center">
        ...
        <div className="flex-1 flex items-center justify-center">
            <h2 className="text-6xl font-bold text-gray-500">8<span className="text-2xl">回</span></h2>
        </div>
    </div>
  );
}
...
const AttendanceCountTotal = () => {
    return (
      <div className="h-full w-full flex flex-col gap-2 items-center justify-center">
          ...
          <div className="flex-1 flex items-center justify-center">
              <h2 className="text-6xl font-bold text-gray-500">120<span className="text-2xl">回</span></h2>
          </div>
      </div>
    );
  }
